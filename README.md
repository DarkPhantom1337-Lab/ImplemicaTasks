...
Task-1 -> 1. Если мы из корректно записанного арифметического выражения, содержащего числа, знаки операций и открывающие и закрывающие круглые скобки выбросим числа и знаки операций, а затем запишем оставшиеся в выражении скобки без пробелов между ними, то полученный результат назовем правильным скобочным выражением [скобочное выражение "(()(()))" - правильное, а "()(" и "())(" - нет].
...
3
2
GitHub: https://github.com/DarkPhantom1337-Lab/ImplemicaTasks/blob/main/src/ua/darkphantom1337/implenica/task/second/SecondTaskMain.java

Task-3 -> 3. Find the sum of the digits in the number 100! (i.e. 100 factorial) 
{Correct answer: 648}
GitHub: https://github.com/DarkPhantom1337-Lab/ImplemicaTasks/blob/main/src/ua/darkphantom1337/implenica/task/third/ThirdTaskMain.java
